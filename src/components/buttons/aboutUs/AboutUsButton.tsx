...
export default function AboutUsButton({}: Props) {
  return (
    <>
      <Link
        href="/"
        className="z-10 mx-auto flex items-center gap-2 font-medium italic text-my-gray3 xl:text-lg 2560:text-xl"
      >
        <svg
          className="xl:h-20 xl:w-20 2560:h-24 2560:w-24"
          width="51"
          height="38"
          viewBox="0 0 51 38"
          fill="none"
