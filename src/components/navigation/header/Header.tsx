...
export default function Header({}: Props) {
  return (
    <>
      {/* mobile screen */}
      <header className="flex h-20 w-full border-b border-my-black bg-my-white xl:hidden">
        {/* Logo */}
        ...
        {/* Menu */}
        <nav className="flex w-1/2 items-center justify-center gap-3">
          {/* search logo */}
          <svg
            className="mr-2"
            width="24"
      ...
      {/* desktop screen */}
      <header className="hidden h-24 border-b border-black bg-my-white xl:flex 2560:h-28">
        <div className="flex w-1/4 items-center justify-start border-r border-black px-8">
          <h2 className="text-2xl font-bold uppercase 2560:text-3xl">Pollax</h2>
        </div>
        <nav className="flex w-2/4 items-center justify-start gap-12 border-r border-black px-8 font-medium 2560:text-lg">
          <h3>About Us</h3>
          <h3>Projects</h3>
          <h3>News</h3>
          <h3>Careers</h3>
        ...
        <nav className="flex w-1/4 items-center justify-between px-8 font-medium 2560:text-lg">
          <h3>Private clients</h3>
          <span className="flex gap-6 2560:gap-8">
            {/* search logo */}
            <svg
              className="2560:h-8 2560:w-8"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
